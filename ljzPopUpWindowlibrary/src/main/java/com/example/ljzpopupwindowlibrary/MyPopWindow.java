...
public class MyPopWindow extends PopupWindow {
        ...
        /** 数据列表 */
        private List<PopUpWindowItem> mList;

        public MyPopWindow(Context context, List<PopUpWindowItem> list, int style){
            ...
            llBG.setGravity(Gravity.CENTER_VERTICAL | Gravity.CENTER_HORIZONTAL);
            // 根据类型修改背景
            switch (style){
                case STYLE_WEIXIN:
