...
public class TextMovementMethods extends LinkMovementMethod {
    ...
    private com.example.travel.widget.TextClickSpans mTextClickSpan;
...
//            }
     ...
     * @return
     */
    private com.example.travel.widget.TextClickSpans getTextSpan(TextView widget, Spannable spannable, MotionEvent event) {
        ...
        com.example.travel.widget.TextClickSpans[] link = spannable.getSpans(off, off, com.example.travel.widget.TextClickSpans.class);
        com.example.travel.widget.TextClickSpans touchedSpan = null;
        if (link.length > 0) {
            touchedSpan = link[0];
        }
        return touchedSpan;
